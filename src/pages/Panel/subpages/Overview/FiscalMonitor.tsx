...
const DocumentComponent: React.FC<{ document?: any }> = ({ document }) => {
    return (
        <Box sx={{ width: "100%", gap: "1vw" }}>
            <Box sx={{ flexDirection: "column", width: "70%", color: "#555" }}>
    ...
    return (
        <Box sx={{ height: "100%", width: "30%" }}>
            <Box sx={{ flex: 1, gap: "1vw", flexDirection: "column" }}>
                <Box sx={{ alignItems: "center", gap: "2vw", width: "100%" }}>
                ...
                <Paper
                    ...
                    <Button
                        variant="contained"
                        sx={{ borderRadius: "30px", textTransform: "none", position: "absolute", bottom: "1vw", right: "1vw", gap: "0.5vw" }}>
                        <AddOutlined />
