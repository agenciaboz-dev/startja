    ...
    return (
        ...
        >
                ...
                >
                    ...
                    >
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={formik.values.discrimina_impostos}
                ...
                >
                    ...
                    >
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={formik.values.habilita_nfe}
                                    name="habilita_nfe"
                                    onChange={formik.handleChange}
                                />
                            }
                    ...
                    <Tooltip
                        ...
                        title={
                            <Box sx={toolTipStyle}>
                                Informa se empresa será habilitada para emissão de NFCe – Nota Fiscal ao Consumidor
                    ...
                    >
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={formik.values.habilita_nfce}
                                    name="habilita_nfce"
                                    onChange={formik.handleChange}
                                />
                            }
            ...
            <Grid container spacing={2}>
                <Grid item xs={isMobile ? 12 : 6}>
                    <Tooltip
                        ...
                        title={
                            <Box sx={toolTipStyle}>
                                Próximo número da NFe a ser emitida. Depois, será incrementado automaticamente.
                            </Box>
                        }
                    >
                        <TextField
                ...
                <Grid item xs={isMobile ? 12 : 6}>
                    <Tooltip
                        enterTouchDelay={100}
                        title={<Box sx={toolTipStyle}>Série da NFe a ser emitida. Valor padrão: 1</Box>}
                    >
                        <TextField
                            required
                            label="Série de NFE"
            ...
            >
                ...
                <RadioGroup
                    value={formik.values.recolhimento}
                    onChange={formik.handleChange}
                    name="recolhimento"
                    sx={{ marginTop: "0.5vw" }}
                >
                    <FormControlLabel
                        ...
                        control={<Radio />}
                        defaultChecked
                        label="Recolhimento pela folha de pagamento"
                    />
