export const cofins_situacao_tributaria_values: {
...
}[] = [
    {
        ...
        fields: [
            { field: "cofins_reducao_base_calculo", label: "Percentual de redução da base de cálculo", type: "number", xs: 6 },
            // Este campo cofins_reducao_base_calculo não existe no NotaFiscalXML.html, provavelmente só é usado aqui internamente
            {
                ...
                disabled: true,
                formula:
                    "{product_formik.values.valor_unitario_comercial} * {product_formik.values.quantidade} - ({formik.cofins_reducao_base_calculo} / 100) * {product_formik.values.valor_unitario_comercial} * {product_formik.values.quantidade}",
                xs: 6,
            },
